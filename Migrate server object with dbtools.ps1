...
#Copy databases not in log shipping ie Maintenance, companyXAdmin  
...
Start-DbaMigration -Verbose -Source sqlhost  -SourceSqlCredential $cred -Destination sqlhost-sql-new3  -DestinationSqlCredential $cred -Exclude Databases, Logins, AgentServer | out-file -FilePath C:\copylog.txt
