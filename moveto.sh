...
# Author:   Craig Yancey, Acompany DBA
...
# a "mount point" permanently linked to the directory on Aserver-sql002 where the backup gets created...
source=/opt/?
...
scripts=/home/Acompany-svc/scripts
